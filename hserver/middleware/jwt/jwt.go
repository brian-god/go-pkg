...
func Handler(tokenizer *token.Token) app.HandlerFunc {
...
// HandlerPorto token处理
//func HandlerPorto(tokenizer *token.Token) app.HandlerFunc {
//	return func(ctx context.Context, c *app.RequestContext) {
//		authorization := c.Request.Header.Get("Authorization")
//		if authorization == "" {
//			i18Mag := hertzI18n.MustGetMessage(ctx, constant.ReasonTokenEmpty)
//			c.ProtoBuf(http.StatusOK, &apiNetV2.Result{Code: http.StatusUnauthorized, Msg: i18Mag, Reason: constant.ReasonTokenEmpty, ErrMsg: constant.ReasonTokenEmpty})
//			c.Abort()
//			return
//		}
//
...
//		if err := tokenizer.Verify(parts[1], &accessToken); err != nil {
//			i18Mag := hertzI18n.MustGetMessage(ctx, constant.ReasonTokenVerifyFail)
//			c.ProtoBuf(http.StatusOK, &apiNetV2.Result{Code: http.StatusUnauthorized, Msg: i18Mag, Reason: constant.ReasonTokenVerifyFail, ErrMsg: constant.ReasonTokenVerifyFail})
//			c.Abort()
//			return
//		}
//		accessToken.AccessToken = parts[1]
